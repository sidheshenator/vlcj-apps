...
public class StatusPanel extends JPanel {
  ...
  public void setModel(DirectoryEntry entry) {
    if(entry != null) {
      nameValueLabel.setText("<html><b>" + entry.getName() + "</b></html>");
      genreValueLabel.setText("<html><b>" + entry.getGenre() + "</b></html>");
      addressValueLabel.setText("<html><b>" + entry.getUrl() + "</b></html>");
      typeValueLabel.setText("<html><b>" + entry.getType() + "</b></html>");
    }
    else {
